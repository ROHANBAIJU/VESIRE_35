...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'healthyNoDisease': 'Healthy - No diseases detected',
    ...
    'hi': {
      ...
      'scanPlant': 'स्कैन करें',
      'garden': 'बगीचा',
      'myGarden': 'मेरा बगीचा',
      'guide': 'मार्गदर्शिका',
      'plantGuide': 'पौधों की मार्गदर्शिका',
      'plantGuides': 'पौधों की मार्गदर्शिकाएं',
      'community': 'समुदाय',
      ...
      // Tips
      'tipWateringTitle': 'पानी देने के सुझाव',
      'tipWateringDesc': 'बेहतर अवशोषण के लिए सुबह जल्दी या शाम को पानी दें',
      'tipSunlightTitle': 'धूप की आवश्यकताएं',
      'tipSunlightDesc': 'अधिकांश पौधों को प्रतिदिन 6-8 घंटे धूप की आवश्यकता होती है',
      'tipSoilTitle': 'मिट्टी का स्वास्थ्य',
      'tipSoilDesc': 'अत्यधिक पानी देने से बचने के लिए पहले मिट्टी की नमी जांचें',
      
      // Recent Activity
      'recentActivity': 'हाल की गतिविधि',
      'scannedHoursAgo': '2 घंटे पहले स्कैन किया',
      'scannedYesterday': 'कल स्कैन किया',
      'healthyNoDisease': 'स्वस्थ - कोई बीमारी नहीं पाई गई',
      ...
      'wateringSchedule': '💧 पानी देने का समय',
      'wateringTip': 'बेहतर अवशोषण के लिए अपने पौधों को सुबह जल्दी या शाम को पानी दें।',
      'sunlightRequirements': '☀️ धूप की आवश्यकताएं',
      'sunlightTip': 'अधिकांश पौधों को स्वस्थ विकास के लिए प्रतिदिन 6-8 घंटे धूप की आवश्यकता होती है।',
      'soilHealth': '🌱 मिट्टी का स्वास्थ्य',
      'soilTip': 'पानी देने से पहले मिट्टी की नमी जांचें। अत्यधिक पानी जड़ों को नुकसान पहुंचा सकता है।',
      ...
      'diseaseDetectedMessage': 'रोग पाया गया लेकिन विस्तृत जानकारी ज्ञान आधार में उपलब्ध नहीं है।',
    ...
    'kn': {
      ...
      'tipSunlightDesc': 'ಹೆಚ್ಚಿನ ಸಸ್ಯಗಳಿಗೆ ಪ್ರತಿದಿನ 6-8 ಗಂಟೆ ಸೂರ್ಯನ ಬೆಳಕು ಬೇಕಾಗುತ್ತದೆ',
      ...
      'healthyNoDisease': 'ಆರೋಗ್ಯಕರ - ಯಾವುದೇ ರೋಗಗಳು ಪತ್ತೆಯಾಗಿಲ್ಲ',
      ...
      'sunlightTip': 'ಹೆಚ್ಚಿನ ಸಸ್ಯಗಳಿಗೆ ಆರೋಗ್ಯಕರ ಬೆಳವಣಿಗೆಗೆ ಪ್ರತಿದಿನ 6-8 ಗಂಟೆ ಸೂರ್ಯನ ಬೆಳಕು ಬೇಕಾಗುತ್ತದೆ.',
      'soilHealth': '🌱 ಮಣ್ಣಿನ ಆರೋಗ್ಯ',
      'soilTip': 'ನೀರು ಹಾಕುವ ಮೊದಲು ಮಣ್ಣಿನ ತೇವಾಂಶವನ್ನು ಪರಿಶೀಲಿಸಿ. ಅತಿಯಾದ ನೀರು ಬೇರುಗಳಿಗೆ ಹಾನಿಯುಂಟುಮಾಡಬಹುದು.',
      ...
      'login': 'ಲಾಗಿನ್',
      'signInWith': 'ಅಥವಾ ಇದರೊಂದಿಗೆ ಸೈನ್ ಇನ್ ಮಾಡಿ',
      ...
      'diseaseDetectedMessage': 'ರೋಗ ಪತ್ತೆಯಾಗಿದೆ ಆದರೆ ವಿವರವಾದ ಮಾಹಿತಿ ಜ್ಞಾನ ಬೇಸ್‌ನಲ್ಲಿ ಲಭ್ಯವಿಲ್ಲ.',
      'consultExpert': 'ಚಿಕಿತ್ಸೆ ಶಿಫಾರಸುಗಳಿಗಾಗಿ ಸ್ಥಳೀಯ ಕೃಷಿ ತಜ್ಞರನ್ನು ಸಂಪರ್ಕಿಸಿ',
      'errorFetchingDiagnosis': 'ರೋಗನಿರ್ಣಯ ಮಾಹಿತಿಯನ್ನು ಪಡೆಯುವಲ್ಲಿ ದೋಷ. ದಯವಿಟ್ಟು ನಿಮ್ಮ ಸಂಪರ್ಕವನ್ನು ಪರಿಶೀಲಿಸಿ.',
